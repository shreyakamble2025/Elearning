...
<title>Building Material And Construction - LearnHub</title>
...
<header class="header">
    <h1>Building Material And Construction</h1>
</header>
...
<main class="container">
    <div class="card">
        ...
        <div class="materials-grid">
            ...
            <a href="ce_pepar_Building_Material_And_Construction.php" target="_blank" class="item-link">
                <span class="item-icon">&#10067;</span>
            ...
            <!-- Certificate -->
            <a href="quiz/building_material_construction_certificate.php" class="item-link">
                <span class="item-icon">&#127891;</span>
