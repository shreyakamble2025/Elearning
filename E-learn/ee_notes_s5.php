...
<title>Semester 5 Syllabus - LearnHub</title>
        ...
        <tbody>
          ...
          if ($result && mysqli_num_rows($result) > 0) {
              ...
              while ($row = mysqli_fetch_assoc($result)) {
                  ...
                  $semester = !empty($row['semester']) ? $row['semester'] : 'Sem 5';
                  $id = $row['id'];
              ...
              ?>
              <tr>
                <td colspan="4" class="no-data">No syllabus PDFs found for Semester 5 in database.</td>
              </tr>
              <?php
          }
          ?>
