...
<title>Semester 3 Syllabus - LearnHub</title>
        ...
        <tbody>
          ...
          if ($result && mysqli_num_rows($result) > 0) {
              ...
              while ($row = mysqli_fetch_assoc($result)) {
                  ...
                  $semester = !empty($row['semester']) ? $row['semester'] : 'Sem 2';
                  $id = $row['id'];
              ...
              ?>
              <tr>
                <td colspan="4" class="no-data">No syllabus PDFs found for Semester 3 in database.</td>
              </tr>
              <?php
          }
          ?>
