...
<title>Construction Project Management - LearnHub</title>
...
<main class="container">
    <div class="card">
        ...
        <div class="materials-grid">
            ...
            <a href="ce_pepar_Construction_Project_Management.php" target="_blank" class="item-link">
                <span class="item-icon">&#10067;</span>
                <span>Previous Question Papers</span>
            </a>

            <!-- Quiz -->
            <a href="construction_project_management_quiz.php" class="item-link">
                <span class="item-icon">&#9997;</span>
                <span>Quiz</span>
            </a>
