...
<title>Transportation Engineering - LearnHub</title>
...
<main class="container">
    <div class="card">
        ...
        <div class="materials-grid">
            ...
            <a href="ce_pepar_Transportation_Engineering.php" target="_blank" class="item-link">
                <span class="item-icon">&#10067;</span>
                <span>Previous Question Papers</span>
            </a>

            <!-- Quiz -->
            <a href="transportation_engineering_quiz.php" class="item-link">
                <span class="item-icon">&#9997;</span>
                <span>Quiz</span>
            </a>
