...
<title>Water Resoureces Engineering - LearnHub</title>
...
<header class="header">
    <h1>Water Resoureces Engineering</h1>
</header>
...
<main class="container">
    <div class="card">
        ...
        <div class="materials-grid">
            ...
            <a href="ce_pepar_Water_Resoureces_Engineering.php" target="_blank" class="item-link">
                <span class="item-icon">&#10067;</span>
                <span>Previous Question Papers</span>
            </a>

            <!-- Quiz -->
            <a href="water_resources_engineering_quiz.php" class="item-link">
                <span class="item-icon">&#9997;</span>
                <span>Quiz</span>
            </a>
