...
<title>Semester 2 Question Papers - LearnHub</title>
<style>
*{
    margin:0;
    padding:0;
...
<header class="header">
    <a href="question_paper.php" class="back-btn">â† Back</a>
    <h1>Semester 2 Question Papers</h1>
</header>
            ...
            else
            {
                echo "<tr>
                        <td colspan='4' class='no-data'>
                            No Question Papers Found For Semester 2
                        </td>
                      </tr>";
            }
            ?>
