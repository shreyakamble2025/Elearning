...
<title>Applied Science - LearnHub</title>
...
<main class="container">
    <div class="card">
        ...
        <div class="materials-grid">
            ...
            <a href="admin/uploads/applied_science_qp.pdf" target="_blank" class="item-link">
                <span class="item-icon">&#10067;</span>
                <span>Previous Question Papers</span>
            </a>

            <!-- Quiz -->
            <a href="applied_science_quiz.php" class="item-link">
                <span class="item-icon">&#9997;</span>
                <span>Quiz</span>
            </a>

            <!-- Certificate -->
            <a href="quiz/applied_science_certificate.php" class="item-link">
                <span class="item-icon">&#127891;</span>
