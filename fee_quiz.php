...
<h1 class="heading">
Semester 1 - Fundamentals of Electrical Engineering Quiz
</h1>
...
<label><input type="radio" name="q5" value="C"> I = VR</label>
<label><input type="radio" name="q5" value="D"> R = VI</label>
</div>

<div class="question">
<h3>6. Electrical energy is measured in</h3>
...
<label><input type="radio" name="q8" value="A"> One path for current</label>
<label><input type="radio" name="q8" value="B"> Two paths</label>
<label><input type="radio" name="q8" value="C"> Three paths</label>
<label><input type="radio" name="q8" value="D"> No path</label>
</div>

<div class="question">
<h3>9. Fuse is used for</h3>
<label><input type="radio" name="q9" value="A"> Lighting</label>
<label><input type="radio" name="q9" value="B"> Heating</label>
<label><input type="radio" name="q9" value="C"> Measurement</label>
...
<label><input type="radio" name="q11" value="C"> Open Circuit</label>
<label><input type="radio" name="q11" value="D"> Ground</label>
</div>

<div class="question">
<h3>12. Unit of inductance is</h3>
<label><input type="radio" name="q12" value="A"> Volt</label>
<label><input type="radio" name="q12" value="B"> Ohm</label>
<label><input type="radio" name="q12" value="C"> Henry</label>
<label><input type="radio" name="q12" value="D"> Farad</label>
</div>

<div class="question">
<h3>13. MCB stands for</h3>
<label><input type="radio" name="q13" value="A"> Main Circuit Board</label>
<label><input type="radio" name="q13" value="B"> Miniature Circuit Breaker</label>
<label><input type="radio" name="q13" value="C"> Motor Control Board</label>
<label><input type="radio" name="q13" value="D"> Main Control Breaker</label>
</div>

<div class="question">
<h3>14. Electrical power is</h3>
<label><input type="radio" name="q14" value="A"> V × I</label>
<label><input type="radio" name="q14" value="B"> V + I</label>
<label><input type="radio" name="q14" value="C"> V ÷ I</label>
<label><input type="radio" name="q14" value="D"> I² ÷ R</label>
</div>
...
<label><input type="radio" name="q15" value="C"> Conduction</label>
...
<div class="question">
<h3>18. Earthing is used for</h3>
<label><input type="radio" name="q18" value="A"> Lighting</label>
<label><input type="radio" name="q18" value="B"> Safety</label>
<label><input type="radio" name="q18" value="C"> Decoration</label>
<label><input type="radio" name="q18" value="D"> Heating</label>
</div>
...
<div class="question">
<h3>20. Electrical engineering deals with</h3>
<label><input type="radio" name="q20" value="A"> Generation, Transmission and Utilization of Electricity</label>
<label><input type="radio" name="q20" value="B"> Building Design</label>
