...
<header class="header">
  <h1>Electrical Engineering Notes</h1>
</header>
...
<main class="container">
  ...
  <div class="semester-grid">
    ...
    <div class="card">
      <h2>Semester 1</h2>
      <a href="ee_notes_s1.php">Open Notes</a>
    </div>

    <div class="card">
      <h2>Semester 2</h2>
      <a href="ee_notes_s2.php">Open Notes</a>
    </div>

    <div class="card">
      <h2>Semester 3</h2>
      <a href="ee_notes_s3.php">Open Notes</a>
    </div>

    <div class="card">
      <h2>Semester 4</h2>
      <a href="ee_notes_s4.php">Open Notes</a>
    </div>

    <div class="card">
      <h2>Semester 5</h2>
      <a href="ee_notes_s5.php">Open Notes</a>
    </div>

    <div class="card">
      <h2>Semester 6</h2>
      <a href="ee_notes_s6.php">Open Notes</a>
    </div>
