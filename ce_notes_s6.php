...
<title>Semester 6 Syllabus - LearnHub</title>
...
<header class="header">
  ...
  <h1>Semester 6 Notes List</h1>
</header>

<main class="container">
  <div class="card">
    <h2>Available Subject Notes</h2>
        ...
        <tbody>
          ...
          if ($result && mysqli_num_rows($result) > 0) {
              ...
              while ($row = mysqli_fetch_assoc($result)) {
                  ...
                  $semester = !empty($row['semester']) ? $row['semester'] : 'Sem 6';
                  $id = $row['id'];
				  
				  $notes_query = mysqli_query($conn, "SELECT * FROM study_material WHERE subject ='$subject_name' LIMIT 1");
              ...
              ?>
              <tr>
                <td colspan="4" class="no-data">No syllabus PDFs found for Semester 6 in database.</td>
              </tr>
              <?php
          }
          ?>
